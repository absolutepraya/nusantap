	...
	return (
		<>
			...
			>
				...
				{!isLoading && (
					<ScrollableFeed className={`relative flex h-full w-full flex-col items-center justify-between overflow-hidden bg-white py-8 shadow-xl`}>
						{/* Image background */}
						<img
						...
						<div className="z-10 flex w-full flex-col items-center space-y-2">
							...
							<div className="relative h-auto w-full">
								<div className="relative !mt-0 flex w-full flex-row space-x-4 px-8 text-white">
									<IconToolsKitchen2
										size={90}
										strokeWidth={2}
									/>
								...
								<div className="absolute -bottom-2 h-1 w-full rounded-full bg-gray-400">
