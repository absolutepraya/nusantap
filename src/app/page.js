		...
		<div className="!w-screen !h-screen flex items-center justify-center bg-gray-100 ">
			<div className="bg-white !h-full !aspect-[9/19.5] flex flex-col items-center relative px-3 py-8 justify-between shadow-2xl">
				<div className="flex flex-row w-full space-x-3 justify-end">
					<div className="border rounded-full border-[#d3d4d3] px-6 h-[38px] flex items-center justify-center">
						<p>Bahasa</p>
					</div>
					<div className="border rounded-full border-[#d3d4d3] w-[38px] h-[38px] flex items-center justify-center">
						<IconQuestionMark size={24} color="#5699fd" strokeWidth={3} />
					</div>
				</div>
				<div className="flex flex-row space-x-0 items-center w-full justify-center pr-2">
					<Image src="/images/satusehat.png" width={130} height={130} alt="SATUSEHAT" />
					<p className="text-3xl font-extralight">SATUSEHAT</p>
				</div>
				<div className="flex flex-col w-full h-48 space-y-3">
