    ...
    return (
        <div className="!w-screen !h-screen flex items-center justify-center bg-gray-100 ">
            <div className="bg-white !h-full !aspect-[9/19.5] flex flex-col items-center relative px-4 py-8 justify-between shadow-2xl">
                ...
                <div className='bg-[#5699fd] text-white flex items-center justify-center rounded-lg h-12 w-full z-10 relative cursor-pointer' onClick={() => window.location.href = '/home/'}>
